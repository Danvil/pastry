...
int main(void)
{
	...
	pastry::texture_2d tex1 = pastry::texture_2d::create_normal<float,3>(GL_RGB8, 160, 120, tex_pixels.data());
	tex1.bind();

	pastry::texture_2d::activate_unit(1);
	pastry::texture_2d tex2 = pastry::texture_load("assets/kitten.jpg");
	tex2.bind();
